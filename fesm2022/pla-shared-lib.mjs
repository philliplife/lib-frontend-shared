...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: PlaTableBodyComponent, decorators: [{
            ...
            args: [{ selector: 'tr[pla-table-body]', imports: [
                        ...
                        NumberDecimalPipe,
                        // BuddhistDatePipe,
                    ], template: "@if (isShowSelectionColumn) {\n  <td style=\"width: 3rem; text-align: center\">\n    @if (selectionMode === 'multiple') {\n      <p-tableCheckbox [value]=\"rowData\" />\n    } @else {\n      <p-tableRadioButton [value]=\"rowData\" />\n    }\n  </td>\n}\n\n@for (column of tableColumns; track $index) {\n  <td\n    [ngStyle]=\"{\n      'text-align': column.textAlign,\n      'min-width': column.minWidth,\n      'max-width': column.maxWidth,\n      'border-left': column.frozenColumn ? '1px solid #e2e8f0' : 'none',\n      'border-right': column.frozenColumn ? '1px solid #e2e8f0' : 'none',\n    }\"\n    [alignFrozen]=\"column.alignFrozen ? column.alignFrozen : 'right'\"\n    pFrozenColumn\n    [frozen]=\"column.frozenColumn ? true : false\"\n  >\n    <div\n      [ngStyle]=\"{\n        'min-height': column.minHeight,\n        height: '100%',\n        display: 'flex',\n        'align-items': 'center',\n        'justify-content':\n          column.columnType === 'action' ? 'center' : column.textAlign,\n      }\"\n    >\n      @switch (column.columnType) {\n        @case (\"text\") {\n          @if (rowData[column.field] != null && rowData[column.field] !== \"\") {\n            {{ rowData[column.field] }}\n          } @else {\n            -\n          }\n        }\n        @case (\"date\") {\n          <!-- @if (column.dateLocalBuddhist) {\n            {{ rowData[column.field] | buddhistDate: column.dateFormat }}\n          } @else {\n            {{\n              rowData[column.field]\n                ? (rowData[column.field]\n                  | date: column.dateFormat || \"dd/MM/yyyy\")\n                : \"-\"\n            }}\n          } -->\n          {{\n            rowData[column.field]\n              ? (rowData[column.field]\n                | date: column.dateFormat || \"dd/MM/yyyy\")\n              : \"-\"\n          }}\n        }\n        @case (\"decimal\") {\n          {{\n            column.field\n              ? (rowData[column.field] | numberDecimal: column.decimalDigit)\n              : \"\"\n          }}\n        }\n        @case (\"tag\") {\n          <!-- icon=\"pi pi-circle-fill\" -->\n          <p-tag\n            [value]=\"rowData[column.field].value\"\n            [severity]=\"getSeverity(rowData[column.field].severity)\"\n          ></p-tag>\n        }\n        @case (\"text-badge\") {\n          @if (\n            column.badgeField &&\n            rowData[column.badgeField] != null &&\n            rowData[column.badgeField] !== \"\"\n          ) {\n            <p-overlaybadge\n              [value]=\"rowData[column.badgeField]\"\n              [severity]=\"column.badgeSeverity\"\n              styleClass=\"pla-count-badge\"\n            >\n              <span>{{\n                rowData[column.field] != null && rowData[column.field] !== \"\"\n                  ? rowData[column.field]\n                  : \"-\"\n              }}</span>\n            </p-overlaybadge>\n          } @else {\n            {{\n              rowData[column.field] != null && rowData[column.field] !== \"\"\n                ? rowData[column.field]\n                : \"-\"\n            }}\n          }\n        }\n        @case (\"action\") {\n          <div class=\"flex justify-content-center align-items-center\">\n            @if (column.action_Buttons && column.action_Buttons.length === 1) {\n              <div\n                [ngStyle]=\"{\n                  display: 'flex',\n                  'align-items': 'center',\n                  'justify-content': 'center',\n                  'min-height': column.minHeight,\n                }\"\n              >\n                <ng-container\n                  *appHasMenuUAM=\"\n                    column.menu_UAM;\n                    storage: applicationStorageName\n                  \"\n                >\n                  <ng-container\n                    *appHasPermission=\"\n                      column.action_Buttons[0].permission || '';\n                      storage: applicationStorageName\n                    \"\n                  >\n                    @if (\n                      !(\n                        (`button-${column.action_Buttons[0].label}_${rowData.id}`\n                          | i18nSelect: column?.action_Disable || {}) ===\n                        \"disabled\"\n                      )\n                    ) {\n                      <a\n                        pRipple\n                        class=\"flex items-center p-tieredmenu-item-link\"\n                        [id]=\"\n                          `button-${column.action_Buttons[0].label}_${rowData.id}`\n                        \"\n                        (click)=\"\n                          column.action_Buttons[0].onActionClick(rowData)\n                        \"\n                        (keyup.enter)=\"\n                          column.action_Buttons[0].onActionClick(rowData)\n                        \"\n                        (keyup.space)=\"\n                          column.action_Buttons[0].onActionClick(rowData)\n                        \"\n                        tabindex=\"0\"\n                        role=\"button\"\n                      >\n                        <span\n                          class=\"flex align-items-center p-tieredmenu-item-icon\"\n                          [class]=\"column.action_Buttons[0].icon\"\n                        ></span>\n                      </a>\n                    }\n                  </ng-container>\n                </ng-container>\n              </div>\n            } @else {\n              <p-button\n                [id]=\"'auction-button-' + rowIndex\"\n                (click)=\"menu.toggle($event)\"\n                icon=\"pi pi-ellipsis-v\"\n                variant=\"text\"\n              />\n              <p-tieredmenu\n                #menu\n                [model]=\"column.action_Buttons\"\n                [popup]=\"true\"\n                appendTo=\"body\"\n                styleClass=\"table-action-button\"\n              >\n                <ng-template #item let-item let-hasSubmenu=\"hasSubmenu\">\n                  <ng-container *appHasMenuUAM=\"item.menu_UAM\">\n                    <ng-container\n                      *appHasPermission=\"\n                        item.permission;\n                        storage: applicationStorageName\n                      \"\n                    >\n                      @if (\n                        !(\n                          (`button-${item.label}_${rowData.id}`\n                            | i18nSelect: column?.action_Disable || {}) ===\n                          \"disabled\"\n                        )\n                      ) {\n                        <a\n                          pRipple\n                          class=\"flex items-center w-full p-tieredmenu-item-link\"\n                          [id]=\"`button-${item.label}_${rowData.id}`\"\n                          (click)=\"item.onActionClick(rowData)\"\n                          (keyup.enter)=\"item.onActionClick(rowData)\"\n                          (keyup.space)=\"item.onActionClick(rowData)\"\n                          tabindex=\"0\"\n                          role=\"button\"\n                        >\n                          <span\n                            class=\"flex align-items-center p-tieredmenu-item-icon\"\n                            [class]=\"item.icon\"\n                          ></span>\n                          <span class=\"ml-2\">{{ item.label }}</span>\n                          @if (hasSubmenu) {\n                            <i class=\"pi pi-angle-right ml-auto\"></i>\n                          }\n                        </a>\n                      }\n                    </ng-container>\n                  </ng-container>\n                </ng-template>\n              </p-tieredmenu>\n            }\n          </div>\n        }\n\n        @default {\n          {{ column.field ? rowData[column.field] : \"\" }}\n        }\n      }\n    </div>\n  </td>\n}\n", styles: [":host ::ng-deep .p-overlaybadge .p-badge.pla-count-badge{min-width:1.5rem;width:1.5rem;height:1.5rem;padding:0;border-radius:50%;transform:translate(100%,-55%)}\n"] }]
...
class PlaTableComponent {
    ...
    // Remark: Fires on every selection change regardless of trigger (row click,
    // p-tableRadioButton, p-tableCheckbox, or the p-tableHeaderCheckbox select-all/none
    ...
    ngOnChanges() {
        ...
        this.normalizeSelectionShape();
        // this.onGetFilterFromLocalStorage();
    }
    // Remark: PrimeNG's Table expects [selection] to be a single object for
    // selectionMode: 'single' and an array for 'multiple' (required by p-tableCheckbox /
    // p-tableHeaderCheckbox). Reconcile the shape whenever selectionMode changes so
    // switching modes at runtime doesn't hand PrimeNG a mismatched selection value.
    normalizeSelectionShape() {
        const isMultiple = this.tableConfig.selectionMode === 'multiple';
        if (isMultiple && !Array.isArray(this.selectedRow)) {
            this.selectedRow = [];
        }
        else if (!isMultiple && Array.isArray(this.selectedRow)) {
