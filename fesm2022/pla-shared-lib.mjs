...
import * as i2$2 from 'primeng/divider';
import { DividerModule } from 'primeng/divider';
import * as i2$3 from 'primeng/splitbutton';
import { SplitButtonModule } from 'primeng/splitbutton';
import * as i1$2 from 'primeng/dialog';
import { DialogModule } from 'primeng/dialog';
import * as i3$5 from 'angular-svg-icon';
...
import * as i2$4 from 'primeng/stepper';
...
class PlaFormInputTextComponent {
    ...
    onHandle(event) {
        console.log('testValue1.0', event);
    }
...
class PlaFormInputArrayComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: PlaFormInputArrayComponent, isStandalone: true, selector: "pla-form-input-array", inputs: { pageState: "pageState", form: "form", formArrayName: "formArrayName", createItemFn: "createItemFn", formSections: "formSections", isSubmitted: "isSubmitted", isLoadingPackage: "isLoadingPackage", isAllowAddAnyPosition: "isAllowAddAnyPosition", isDisplayNumberOrder: "isDisplayNumberOrder", additionalButtons: "additionalButtons" }, ngImport: i0, template: "<!-- Binding parent's form  -->\n<div [formGroup]=\"form\">\n  <div [formArrayName]=\"formArrayName\">\n    @for (item of getControls(); track i; let i = $index) {\n      <div class=\"flex align-items-center justify-content-center \">\n\n   \n    <div [formGroupName]=\"i\" class=\"flex align-items-center w-full gap-1 item-container\">\n      <div class=\"order-number-container\">\n        {{i + 1}}\n      </div>\n      \n      <!-- Dynamic Sections -->\n      <div class=\"w-full flex flex-row flex-wrap py-1 gap-1\">\n        @for (section of formSections; track section.key; let j = $index) {\n        <div class=\"col\">\n          <pla-dynamic-form\n            [index]=\"i\"\n            [listFormDesign]=\"section.design\"\n            [listFormGroup]=\"getNestedFormGroup(i, section.key)\"\n            [submitted]=\"isSubmitted\"\n            [loading]=\"isLoadingPackage\"\n          />\n        </div>\n\n        @if (j < formSections.length - 1) {\n        <p-divider\n          [layout]=\"isSmallScreen ? 'horizontal' : 'vertical'\"\n          class=\"my-4\"\n        />\n        } }\n      </div>\n     </div>\n    \n     \n      <!-- Add/Remove Buttons -->\n       @if(pageState === 'Edit'){\n          <div class=\"flex justify-content-between align-items-center gap-3 ml-3 button-container\">\n\n       @if(additionalButtons.length > 0){\n        @for (item of additionalButtons; track $index) {\n        <p-button\n          [disabled]=\"item.isDisable\"\n          [icon]=\"item.icon\"\n          [variant]=\"item.variant\"\n          [severity]=\"item.severity\"\n          (click)=\"item?.bindingFunction(i)\"\n        />\n        }\n       }\n     \n\n        <!-- Additional Buttons -->\n\n        <p-button\n          [disabled]=\"!i && items.length === i + 1\"\n          icon=\"pi pi-trash\"\n          variant=\"outlined\"\n          severity=\"secondary\"\n          (click)=\"removeItem(i)\"\n        />\n\n        @if(isAllowAddAnyPosition){\n          <!-- Remark: Add button appears in every items -->\n          <p-button\n              icon=\"pi pi-plus\"\n              variant=\"outlined\"\n              severity=\"secondary\"\n              (click)=\"addItem(i)\"\n          />\n        }@else {\n          <!-- Remark: Add button appears only last item -->\n         @if (items.length === i + 1) {\n          <p-button\n            icon=\"pi pi-plus\"\n            variant=\"outlined\"\n            severity=\"secondary\"\n            (click)=\"addItem(i)\"\n            />\n          } \n        }\n      </div>\n       }\n   \n    </div>\n    }\n  </div>\n</div>\n", styles: [".button-container{min-width:6rem;max-width:7.5rem}.item-container{position:relative;border:1px solid #d4d4d4;border-radius:.75rem;padding:.5rem;gap:1rem;margin-bottom:.5rem}.order-number-container{position:absolute;min-width:50px;top:0;left:0;display:flex;align-items:center;justify-content:center;border-top-left-radius:.75rem;border-bottom-right-radius:.75rem;border:1px solid #d4d4d4;color:#fff;background-color:var(--color-primary-9);z-index:10}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i2.FormGroupName, selector: "[formGroupName]", inputs: ["formGroupName"] }, { kind: "directive", type: i2.FormArrayName, selector: "[formArrayName]", inputs: ["formArrayName"] }, { kind: "ngmodule", type: DividerModule }, { kind: "component", type: i2$2.Divider, selector: "p-divider", inputs: ["style", "styleClass", "layout", "type", "align"] }, { kind: "ngmodule", type: ButtonModule }, { kind: "component", type: i1.Button, selector: "p-button", inputs: ["type", "iconPos", "icon", "badge", "label", "disabled", "loading", "loadingIcon", "raised", "rounded", "text", "plain", "severity", "outlined", "link", "tabindex", "size", "variant", "style", "styleClass", "badgeClass", "badgeSeverity", "ariaLabel", "autofocus", "fluid", "buttonProps"], outputs: ["onClick", "onFocus", "onBlur"] }, { kind: "component", type: PlaDynamicForm, selector: "pla-dynamic-form", inputs: ["listFormGroup", "listFormDesign", "submitted", "loading", "index"] }] });
}
...
class LoginService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: LoginService, deps: [{ token: i1$4.HttpClient }, { token: AuthStateService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: LoginService, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.HttpClient }, { type: AuthStateService }] });
...
class UserProfileService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: UserProfileService, deps: [{ token: i1$4.HttpClient }], target: i0.ɵɵFactoryTarget.Injectable });
