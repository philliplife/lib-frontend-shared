...
import { Injectable, Component, Input, EventEmitter, Output, forwardRef, Pipe, Directive, inject, TemplateRef, ViewContainerRef, ViewChild } from '@angular/core';
...
const clientLabels = {
    ...
    religion: 'Religion',
    organization_Information: 'LABEL.CLI_CLIENT_ORGANIZATION_INFORMATION',
    registration_Number: 'LABEL.CLI_CLIENT_REGISTRATION_NUMBER',
    registration_Date: 'LABEL.CLI_CLIENT_REGISTRATION_DATE',
    business_Type: 'LABEL.CLI_CLIENT_BUSINESS_TYPE',
    tax_Id: 'Tax ID',
