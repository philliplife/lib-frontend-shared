...
export declare class TokenRefreshService {
    ...
    refreshAndRetry(req: HttpRequest<unknown>, next: HttpHandlerFn, urlConfig: IUrlConfig, clientId: string, applilcationStorageKey: string, envName: string): Observable<HttpEvent<unknown>>;
