...
import { ResponseObjectType } from '../models/response.interface';
...
export declare class UserProfileService {
    ...
    getProfileUam(userName: string, clientId: string, uamBaseApiUrl: string): Observable<ResponseObjectType<IUserProfile>>;
